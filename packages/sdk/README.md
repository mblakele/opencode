...
- Session reads and unloaded permission/form lists do not initialize plugins. Configuration or initial supplied-plugin setup failure prevents capability acquisition, without falling back to another instance. A subsequent request can retry a failed construction.
